...
test.describe.only("Test Ivehte Web", () => {
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto("http://locahost:3000/login");
    ...
    await Promise.all([
      //page.waitForNavigation(/*{ url: 'http://locahost:3000/login' }*/),
      connexion.click(),
  ...
  test("Créer un évenement", async ({ page }) => {
    ...
    await page.goto('http://locahost:3000/dashboard');
    const ongletAgenda = page.locator("text=Mon agenda").first();
    const addEven = page.locator("text=Créer un événement").first();
    // Cliquer sur Mon agenda
    await Promise.all([
      // page.waitForNavigation(/*{ url: 'http://locahost:3000/dashboard' }*/),
      ongletAgenda.click(),
  ...
  test("Add patient", async ({ page }) => {
    /** Début ajout patient */
    await page.goto('http://locahost:3000/patients/add');
  ...
  test("Ajout HDJ", async ({ page }) => {
    await page.goto('http://locahost:3000/hdj/new');
  ...
  test("Modifier un HDJ", async ({ page }) => {
    await page.goto('http://locahost:3000/hdj');
  ...
  //   await page.goto('http://locahost:3000/programmes');
